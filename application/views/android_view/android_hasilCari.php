        ...
        <div id="content">
                ...
                <div class="border bg-light shadow rounded d-flex justify-content-between billStickTop">
                    ...
                    <form class="searchbox" action="<?php echo base_url('Android_controller/cari'); ?>" method="post">
                        <input type="search" placeholder="Cari solusi..." name="cariSolusi" class="searchbox-input" onkeyup="buttonUp();" title="cari solusi" required>
                ...
                <div class="mt-4">
                    <?php if ($countResult > 0) {
                        echo "<div class='alert alert-success' style='text-align: center;'>Menampilkan ".$countResult." data</div>";
                       foreach ($searchResult as $val) : ?>
                        <a href="<?php echo base_url('Android_controller/solusi?tsId=').$val->ts_id ?>" style="text-decoration: none;">
                            <div class="container bg-light shadow-lg rounded-lg p-3 mb-2" style="color: black;">
                                <?php echo $this->bbcode->parse($val->title); ?>
                            </div>
                        </a>

                    <?php endforeach; }else{
                        echo "<div class='alert alert-dark' style='text-align: center;'>Solusi tidak ditemukan!</div>";
                    } ?>
                </div>
