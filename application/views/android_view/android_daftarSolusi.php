        ...
        <div id="content">
                ...
                <div class="border bg-light shadow rounded d-flex justify-content-between billStickTop">
                    ...
                    <div style="color: #7C7C7D;" class="p-1">
                        <button class="btn btn-default" disabled><b style="text-transform: uppercase;"><?php echo $namaPerangkat->w_name; ?></b></button>
                    </div>
                ...
                <div class="mt-4">
                    <span class="d-flex justify-content-center">
                        <img src="<?= base_url('/assets/icon/');?><?=$namaPerangkat->w_icon?>" class="mb-3" style="max-width: 144px;">
                    </span>                    
                    <?php foreach ($daftar_solusi as $val) : ?>
