...
<div class="container mt-2">
  ...
  <div class="container mt-3 border-btm">
    <div class="d-flex justify-content-beetwen row">
      <div class="col-sm-12 col-md-6 col-lg-6">
          <div><h3>Daftar Perangkat Lunak</h3></div>
      </div>
      ...
      <div class="d-flex justify-content-beetwen row">
        <div class="col-7">
          <?php if ($userLevel == "admin" || $userLevel == "Koordinator Laboratorium") { ?>
            ...
            <button class="btn btn-primary btn-sm" onclick="modal()" data-toggle="modal" data-target="#myModal"><b>+</b>Tambah Perangkat Lunak</button>
         <?php }else{ } ?>
        </div>
  	...
  	<div class="table">
          ...
          <thead style="text-align: center;">
            ...
            <?php if ($this->session->userdata('level') == "admin" || $this->session->userdata('level') == "Koordinator Laboratorium") { ?>
    				<div>
    					<a href="<?= base_url('kelolaperangkat/page_editSw');?>?id=<?= $val->w_id; ?>">
          ...
          <?php }else{ } ?>
            ...
            <?php if ($this->session->userdata('level') == "admin" || $this->session->userdata('level') == "Koordinator Laboratorium") { ?>
    				<div>
    					<!--form delete-->
    					<form action="<?php echo base_url('Kelolaperangkat/delSw')?>" method="post">
    						<div class="hide-form">
    							<input type="text" class="btn btn-tersier" name="w_id" value="<?= $val->w_id;  ?>">
                  <input type="text" class="btn btn-tersier" name="w_icon" value="<?= $val->w_icon;  ?>">
    						</div>
  ...
  <!-- AddThings Modal -->
<?php echo form_open_multipart('Kelolaperangkat/addSw'); ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Tambah Perangkat Lunak</h4>
        </div>
        ...
        <div class="modal-body">
            <table style="width: 100%;">
              ...
              <tr class="hide-form"><td>
              	...
              	<input type="text" name="jenis_perangkat" class="form-control form-control-sm" required value="Software" readonly>
              </td></tr>
