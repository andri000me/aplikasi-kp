...
<div class="container mt-2">
  <div class="d-flex flex-column p-3 bg-white text-black border rounded">
      ...
      <div class="container mt-3 border-btm">
        <div class="d-flex justify-content-beetwen row">
          <div class="col-sm-12 col-md-6 col-lg-6">
              <div><h3>Edit Perangkat Lunak</h3></div>
          </div>
      ...
      <?php echo form_open_multipart('Kelolaperangkat/modSw'); ?>
        <div class="mt-2 mb-2">
          <button class="btn btn-primary btn-sm mr-2" type="submit">Simpan</button>
          <a href="<?php echo base_url('Kelolaperangkat/software')?>">
        ...
        <div class="table mt-4">
          <table class="table table-sm table-borderless mt-2">
            <tr>
              ...
              <div class="hide-form">
                <input type="text" name="editperangkat" class="inputbox-2" required value="Software" readonly>
